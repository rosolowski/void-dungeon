...
export async function addCharacter(addCharacterData: AddCharacterDto) {
	...
	const res = await fetch(`${PUBLIC_API_HOST}/users/add-character`, {
		method: 'POST',
		headers: {
...
export async function removeCharacter(removeCharacterData: RemoveCharacterDto) {
	...
	const res = await fetch(`${PUBLIC_API_HOST}/users/remove-character`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export async function getCharacters() {
	...
	const res = await fetch(`${PUBLIC_API_HOST}/users/characters`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
